# 「組み込みRustのライブラリ便利クレート探偵団」第1回 マイコンなどリソースに制約があるデバイスを対象としたロギング・フレームワーク

[インターフェース2024年3月号](https://interface.cqpub.co.jp/magazine/202403/) 「組み込みRustのライブラリ便利クレート探偵団」第1回 マイコンなどリソースに制約があるデバイスを対象としたロギング・フレームワークのサンプルコードです。

このサンプルコードは knurling-rs のテンプレートを nRF52840 向けに使えるようにしたものです。
使用したテンプレートの README 原文は日本語のあとに続きます。
